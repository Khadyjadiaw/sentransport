...
function App() {
  ...
  { id: 8, numero: "34", depart: "Liberté", arrivee: "Médina", arrets: 13, couleur: "#2980b9" },
  { id: 9, numero: "42", depart: "Dieuppeul", arrivee: "Sicap", arrets: 8, couleur: "#8e44ad" },
  { id: 10, numero: "19", depart: "HLM", arrivee: "Sandaga", arrets: 15, couleur: "#d35400" },
];
  return (
    <div className="App">
      <Header />
